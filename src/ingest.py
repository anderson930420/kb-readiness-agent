...
SECTION_ALIASES: dict[str, str] = {
    ...
    "standard_refund_window": "refund window standard monthly subscribers annual subscribers initial purchase 7 days 14 days",
    ...
    "data_deletion": "account data deletion request admin console 30 days",
